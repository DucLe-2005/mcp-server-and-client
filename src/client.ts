...
import { ElicitationAwareTransport } from "./elicitation-transport.js";
import {
...
async function handleResource(uri: string) {
  ...
  if ("text" in content) {
    ...
    console.log("Received binary blob content:", content.blob);
  }
}
